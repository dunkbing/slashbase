	...
	return (
		<header className={styles.header}>
			<div className={styles.leftBtns}>
				{!isShowingSidebar ? (
					<button
						className={"button is-dark " + [styles.btn].join(" ")}
				...
				<Link to={Constants.APP_PATHS.HOME.path}>
					<button
						className={
							...
							[
								styles.btn,
								currentProjectOption !== undefined ? styles.home : "",
							].join(" ")
						}
					>
						<span className="icon">
				...
				<div className={styles.headerCenter}>
					{currentProjectOption !== undefined && (
						<div
							className={`dropdown${isShowingNavDropDown ? " is-active" : ""}`}
						>
					...
					{currentProjectOption !== undefined &&
						currentDBOption !== undefined && (
							<div
								className={`dropdown${isShowingDBDropDown ? " is-active" : ""}`}
							>
								<div className={`dropdown-trigger`}>
									<button
										className={
								...
								{currentDBOption !== undefined && (
									<div>
										<button
											...
											className={
												" button is-dark is-small" + [styles.btn].join(" ")
											}
			...
			<div className={styles.headerMenu}>
				<div
					className={
						"dropdown is-right" + (isShowingDropDown ? " is-active" : "")
					}
				>
					<div
					...
					>
						<div className="dropdown-menu" role="menu">
							<div className="dropdown-content">
								<a
									onClick={() => {
										utils.openInBrowser(Constants.EXTERNAL_PATHS.CHANGELOG);
									}}
