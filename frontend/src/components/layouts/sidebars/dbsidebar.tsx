		...
		<React.Fragment>
			<div className="tabs is-centered">
				<ul>
					<li
						className={
							currentSidebarTab === DBSidebarTabType.DATABASE ? "is-active" : ""
						}
						onClick={() => {
							switchSidebarTab(DBSidebarTabType.DATABASE);
						}}
					>
						<a>
					...
					<li
						className={
							currentSidebarTab === DBSidebarTabType.QUERIES ? "is-active" : ""
						}
						onClick={() => {
							switchSidebarTab(DBSidebarTabType.QUERIES);
						}}
					>
						<a>
							<span className="icon is-small">
					...
					<li
						className={
							currentSidebarTab === DBSidebarTabType.TOOLBOX ? "is-active" : ""
						}
						onClick={() => {
							switchSidebarTab(DBSidebarTabType.TOOLBOX);
						}}
					>
						<a>
							<span className="icon is-small">
			...
			{currentSidebarTab === DBSidebarTabType.DATABASE && (
				<React.Fragment>
					<p className="menu-label">Data Models</p>
			...
			{currentSidebarTab === DBSidebarTabType.QUERIES && (
				<React.Fragment>
					<p className="menu-label">Queries</p>
					<ul className={"menu-list " + styles.menuList}>
						{dbQueries.map((dbQuery: DBQuery) => {
							return (
								<li key={dbQuery.id}>
									<a onClick={() => openQueryTab(dbQuery.id)}>{dbQuery.name}</a>
								</li>
							);
						})}
						<li>
			...
			{currentSidebarTab === DBSidebarTabType.TOOLBOX && (
				<React.Fragment>
					<p className="menu-label">Toolbox</p>
					<ul className={"menu-list " + styles.menuList}>
						<li>
