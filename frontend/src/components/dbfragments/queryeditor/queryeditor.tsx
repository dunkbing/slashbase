				...
				<div className="columns">
					...
					<div className={"column " + styles.buttons}>
						...
						<button
							className="button"
							id="btnFormatQuery"
							data-tooltip-content="Format query"
							onClick={formatQuery}
						>
							<span className="icon is-small">
						...
						<button
							className="button"
							id="btnShowCheatsheet"
							data-tooltip-content="Show Cheatsheet"
							onClick={() => {
						...
						{deleting && (
							<button className="button is-danger is-loading">Deleting</button>
						)}
						&nbsp;&nbsp;
						{!running && (
							<button
								id="btnRunQuery"
								data-tooltip-content="Ctrl+Enter to run query"
						...
						{running && (
							<button className="button is-primary is-loading">Running</button>
						)}
					</div>
				</div>
			</div>
