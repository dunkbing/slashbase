...
const getHealthCheck = async (): Promise<any> => {
  if (isapiService) {
...
const addNewProjectMember = async (
  projectId: string,
  ...
  return await Request.apiInstance
    .post<
      any,
      AxiosResponse<ApiResult<ProjectMember>>
    >(`/project/${projectId}/members/create`, payload)
    .then((res) => res.data);
};
...
const getDBConnectionsByProject = async (
  projectId: string,
...
const getDBDataModelsByConnectionId = async (
  dbConnId: string,
...
const getDBSingleDataModelByConnectionId = async (
  dbConnId: string,
  schemaName: string,
  mName: string,
...
const deleteDBSingleDataModelField = async (
  dbConnId: string,
  schemaName: string,
  mName: string,
  fieldName: string,
...
const addDBSingleDataModelIndex = async (
  dbConnId: string,
  schemaName: string,
  mName: string,
  indexName: string,
...
const deleteDBSingleDataModelIndex = async (
  dbConnId: string,
  schemaName: string,
  mName: string,
  indexName: string,
...
const getDBDataInDataModel = async (
  dbConnId: string,
  schemaName: string,
  mName: string,
  limit: number,
...
const updateDBSingleData = async (
  dbConnId: string,
  schemaName: string,
  mName: string,
  id: string,
  ...
  return await Request.apiInstance
    .post<
      any,
      AxiosResponse<ApiResult<CTIDResponse>>
    >(`/query/data/${dbConnId}/single`, { schema: schemaName, name: mName, id, columnName, value })
    .then((res) => res.data);
};
...
const deleteDBData = async (
  ...
  return await Request.apiInstance
    .post<
      any,
      AxiosResponse<ApiResult<DBQueryResult>>
    >(`/query/data/${dbConnId}/delete`, { schema: schemaName, name: mName, ids })
    .then((res) => res.data);
};

const saveDBQuery = async (
  dbConnId: string,
  name: string,
  query: string,
  queryId: string,
...
const updateRolePermission = async (
  ...
  return await Request.apiInstance
    .post<
      any,
      AxiosResponse<ApiResult<RolePermission>>
    >(`/role/${roleId}/permission`, { roleId, name, value })
    .then((res) => res.data);
};
